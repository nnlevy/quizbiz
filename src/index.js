...
const enhancementStyles = String.raw`
  ...
  .quick-presets .button{min-height:38px;font-size:.82rem}.readiness{margin:4px 0 0;border-radius:10px;font-size:.82rem;font-weight:700;line-height:1.35;padding:8px 10px}.readiness.is-ready{border:1px solid rgba(0,166,166,.3);background:rgba(0,166,166,.1);color:#006f6f}.readiness.is-warn{border:1px solid rgba(255,107,74,.3);background:rgba(255,107,74,.09);color:#7a2d19}.hero-copy h1{max-width:16ch;font-size:clamp(2.85rem,4.7vw,4.85rem);line-height:.95}.product-positioning{display:grid;grid-template-columns:minmax(0,1fr) minmax(320px,.75fr);gap:18px;align-items:start}.position-list{display:grid;gap:10px;margin:0;padding:0;list-style:none}.position-list li{border:1px solid rgba(16,26,63,.1);border-radius:14px;background:rgba(255,255,255,.72);color:var(--ink);font-weight:800;padding:12px 14px}
  ...
  @media(max-width:980px){.product-positioning{grid-template-columns:1fr}}@media(max-width:740px){.quick-presets .button{width:100%}.conversion-strip{grid-template-columns:1fr}.hero-copy h1{font-size:2.45rem;max-width:none}}
`;
